...
def extract_words(df):
    ...
    logger.info("Extrayendo palabras clave del resumen de noticias.")
...
def analyze_trends(df):
    ...
    logger.info("Analizando tendencias en la publicación de noticias.")
